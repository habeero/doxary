...
During the Settings phase, explicitly evaluate a discoverable entry for historical Analysis activity, such as “Analysis History,” “Analysis Activity,” or “Document / Analysis History.” It could provide access to failed attempts, deleted-Analysis history/tombstones, past Analysis activity, and potentially future permanent-removal controls. Final naming, section, destination, and screen architecture remain undecided; possible homes include this Settings entry or another dedicated management surface. Do not add a Settings tile or select the final destination yet. This review should also decide how failed/deleted activity should leave normal Documents browsing. Overall navigation information architecture may be revisited during this phase after Settings capabilities are implemented. This note does not reverse the current no-sidebar decision; the subsequent navigation audit is specified in [Navigation](NAVIGATION.md#deferred-navigation-and-back-stack-audit).
